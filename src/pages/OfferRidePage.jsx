...
export const OfferRidePage = () => {
  const { user, offerRide, isSubmitting, globalError, setActiveTab } = useApp();
  ...
  const [vehicle, setVehicle] = useState(user.vehicle || 'Honda Activa 6G');
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <div>
                  <div style={{ fontSize: '13px', fontWeight: '700', color: 'var(--primary)' }}>
                    {estimatedContribution} Community Credits per Seat
                  </div>
