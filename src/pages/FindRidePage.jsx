          ...
          return (
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '12px' }}>
                ...
                {/* Community Credits Contribution Hero */}
                <div style={{ textAlign: 'right' }}>
                  <div style={{ fontSize: '18px', fontWeight: '800', color: 'var(--primary)' }}>
                    {ride.contribution} Credits
                  </div>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '10px' }}>
                <div style={{ fontSize: '12px', color: 'var(--text-muted)', display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
                  ...
                  {ride.provider.bikeColour && <span>{ride.provider.bikeColour}</span>}
                  {ride.provider.isEv && <span className="badge badge-verified">EV</span>}
          ...
          <div className="modal-content" onClick={e => e.stopPropagation()}>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '13px', marginBottom: '6px' }}>
                <span>Community contribution per seat:</span>
                <span>{selectedRide.contribution} Credits</span>
              </div>
            ...
            {bookingError && (
              <div className="alert alert-danger" style={{ marginBottom: '16px' }}>
                ...
                <div style={{ flex: 1, fontSize: '12px' }}>
                  ...
                  {bookingError.includes('Not enough') && (
                    <button
                      onClick={() => {
                        setSelectedRide(null);
                        setActiveTab('offer');
