...
import { Coins, ShieldCheck, Wifi, WifiOff, LogOut, Bell } from 'lucide-react';
import { useApp } from '../context/AppContext.jsx';

export const Header = () => {
  const { user, wallet, activeTab, setActiveTab, isOffline, toggleOffline, logout, unreadCount, setIsNotificationsOpen } = useApp();
    ...
    <div className="app-container header-inner">
      ...
      <div className="header-tools">
        ...
        <button
          ...
          title={`Activity & Notifications (${unreadCount} unread)`}
